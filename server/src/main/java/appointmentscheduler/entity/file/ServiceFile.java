...
public class ServiceFile {
    ...
    public ServiceFile(String fileName, String fileType, byte[] data, User user) {
    ...
    public ServiceFile(String fileName, String fileType, byte[] data, FileOrigin fileOrigin, User user) {
        this.fileName = fileName;
        this.fileType = fileType;
        this.data = data;
        size = data.length;
